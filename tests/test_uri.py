...
def test_uri_spaces():
    get_uri('tests/ a  ', 'tests/%20a%20%20')
    get_uri('tests/   ', 'tests/%20%20%20')

def test_uri_quotes():
    get_uri('tests/""', 'tests/%22%22')

def test_uri_question():
    get_uri('tests/?toto', 'tests/%3ftoto')

def test_uri_hardcore():
    get_uri('tests/#$%&@@@', 'tests/%23%24%25%26%40%40%40')


def test_uri_percent00_escape():
    get_uri('tests/%00', 'tests/%25%30%30')
